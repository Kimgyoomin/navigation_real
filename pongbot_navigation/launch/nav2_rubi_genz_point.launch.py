#!/usr/bin/env python3
"""
nav2_rubi_genz_point.launch.py

GenZ-ICP-LOCALIZATION + Nav2 launch file for Rubi/PongBot.

Assumed TF semantics:
  GenZ-ICP body      : FRD  (x front, y right, z down), approximately Livox origin
...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            "rviz_config",
            default_value="/home/ams4976/ros2_ws/src/genz-icp/ros/rviz/genz_icp_localization_ros2.rviz",
